...
thSensor = adafruit_mcp9808.MCP9808(i2c)
...
class TemperatureMachine(StateMachine):
    ...
    @property
    def is_heat(self):
        return self.current_state == self.heat

    @property
    def is_cool(self):
        return self.current_state == self.cool

    @property
    def is_off(self):
        return self.current_state == self.off
    ...
    def on_enter_heat(self):
        ...
        #
        redLight.blink(on_time=1, off_time=1)  # Red LED fades in and out
        blueLight.off()  # Ensure Blue LED is off
    ...
    def on_enter_cool(self):
        ##
        blueLight.blink(on_time=1, off_time=1)  # Blue LED fades in and out
        redLight.off()  # Ensure Red LED is off
    ...
    def processTempStateButton(self):
        ...
        ##
        self.cycle()  # Transition to the next thermostat state
    ...
    def processTempIncButton(self):
        ...
        ##
        self.setPoint += 1  # Increase setPoint by 1 degree Fahrenheit
        self.updateLights()  # Update lights based on new temperature
    ...
    def processTempDecButton(self):
        ...
        ##
        self.setPoint -= 1  # Decrease setPoint by 1 degree Fahrenheit
        self.updateLights()  # Update lights based on new temperature
    ...
    def updateLights(self):
        ...
        if self.is_heat:
            if temp < self.setPoint:
                redLight.blink(on_time=1, off_time=1)  # Fade Red LED in/out
            ...
            if temp > self.setPoint:
                blueLight.blink(on_time=1, off_time=1)  # Fade Blue LED in/out
            else:
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            ##
            lcd_line_1 = current_time.strftime("%Y-%m-%d %H:%M:%S")  # Date and Time

            ## Setup Display Line 2
            if (altCounter < 6):
                ##
                lcd_line_2 = f"Temp: {self.getFahrenheit():.2f} F"  # Current Temperature
                altCounter = altCounter + 1

            else:
                ##
                lcd_line_2 = f"{self.current_state.id.capitalize()} @ {self.setPoint} F"  # State & Setpoint
...
##
# Green Button cycles through thermostat states.
...
redButton = Button(25)
##
# Red Button increases setpoint by one degree.
...
##
# Blue Button decreases setpoint by one degree.
